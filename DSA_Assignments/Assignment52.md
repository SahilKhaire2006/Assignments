# Practical – Hash Table with Separate Chaining

**Name:** Sahil Ashok Khaire  
**Roll No.:** 13  
**Title:** Implementation of Hash Table with Collision Resolution using Separate Chaining  
...
- Demonstrate collision handling and chain management

---

## Theory

A **Hash Table** is a data structure that implements an associative array abstract data type, mapping keys to values using a hash function. **Separate Chaining** is a collision resolution technique where each bucket in the hash table contains a linked list of all key-value pairs that hash to that index.
...
Key terms: **Hash Table**, **Separate Chaining**, **Linked List**, **Collision Resolution**, **Bucket**, **Load Factor**, **Hash Function**
...
3. Display load factor and statistics

### Algorithm: Calculate Load Factor
1. Load factor = total elements / table size
2. Return load factor value
...
## Output
![alt text](Assignment52.png)
![alt text](Assignment52-1.png)
![alt text](Assignment52-2.png)